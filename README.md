...
- the `jax-rs-pac4j` library (<em>groupId</em>: **org.pac4j**, *version*: **2.0.2**)
...
See the [release notes](https://github.com/pac4j/jax-rs-pac4j/wiki/Release-Notes). Learn more by browsing the [jax-rs-pac4j Javadoc](http://www.javadoc.io/doc/org.pac4j/jax-rs-pac4j/2.0.2) and the [pac4j Javadoc](http://www.pac4j.org/apidocs/pac4j/2.1.0/index.html).
